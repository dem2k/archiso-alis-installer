...
function check_variables() {
    ...
    check_variables_list "DISPLAY_MANAGER" "$DISPLAY_MANAGER" "auto gdm sddm lightdm lxdm ly" "true" "true"
...
function ask_passwords() {
    ...
    ROOT_PASSWORD_RETYPE="$USER_PASSWORD"
...
function display_manager_ly() {
    pacman_install "ly"
    arch-chroot "${MNT_DIR}" systemctl enable ly.service
}
