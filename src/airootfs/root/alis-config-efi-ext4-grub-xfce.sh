...
sed -i "s/ROOT_PASSWORD=.*/ROOT_PASSWORD=\"ask\"/" ./alis.conf
sed -i "s/ROOT_PASSWORD_RETYPE=.*/ROOT_PASSWORD_RETYPE=\"ask\"/" ./alis.conf
sed -i "s/USER_PASSWORD=.*/USER_PASSWORD=\"ask\"/" ./alis.conf
sed -i "s/USER_PASSWORD_RETYPE=.*/USER_PASSWORD_RETYPE=\"ask\"/" ./alis.conf
